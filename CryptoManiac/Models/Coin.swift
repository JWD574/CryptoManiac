...
struct Coin: Identifiable, Codable {
    ...
    //MARK:  THIS MODEL WILL DECODE RAW DATA FROM API (SEE SAMPLE DATA
    // FOUND IN REMARK ABOVE 👆🏼
    enum CodingKeys: String, CodingKey {
        ...
        case currentHoldings//PERSONAL HOLDINGS OF USERS WALLET
    }
    //MARK:  THIS FUNCTION WILL UPDATE PERSONAL WALLET HOLDINGS WHEN THAT VALUE IS CHANGED BY USER
    ...
    //FUNCTION TO UPDATE HOLDING VALUE OF WALLET
